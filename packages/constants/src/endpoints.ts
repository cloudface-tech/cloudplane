...
// cloudplane website url
export const WEBSITE_URL = process.env.VITE_WEBSITE_URL || "https://cloudface.tech";
// support email
export const SUPPORT_EMAIL = process.env.VITE_SUPPORT_EMAIL || "support@cloudface.tech";
// marketing links
export const MARKETING_PRICING_PAGE_LINK = "https://cloudface.tech/pricing";
export const MARKETING_CONTACT_US_PAGE_LINK = "https://cloudface.tech/contact";
export const MARKETING_PLANE_ONE_PAGE_LINK = "https://cloudface.tech/one";
