...
import type { IPaymentProduct, TBillingFrequency, TProductBillingFrequency } from "@cloudplane/types";
...
export const PLANE_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "CloudPlane Business",
    description:
      "The earliest packaging of Business at $10 a seat a month billed annually, $12 a seat a month billed monthly for CloudPlane Cloud",
    type: "BUSINESS",
    prices: [
      {
 ...
 */
export const TALK_TO_SALES_URL = "https://cloudface.tech/talk-to-sales";
...
export const SUBSCRIPTION_REDIRECTION_URLS: Record<EProductSubscriptionEnum, Record<TBillingFrequency, string>> = {
  ...
  [EProductSubscriptionEnum.PRO]: {
    month: "https://app.cloudface.tech/upgrade/pro/self-hosted?plan=month",
    year: "https://app.cloudface.tech/upgrade/pro/self-hosted?plan=year",
  },
  [EProductSubscriptionEnum.BUSINESS]: {
    month: "https://app.cloudface.tech/upgrade/business/self-hosted?plan=month",
    year: "https://app.cloudface.tech/upgrade/business/self-hosted?plan=year",
  },
  [EProductSubscriptionEnum.ENTERPRISE]: {
    month: TALK_TO_SALES_URL,
    year: TALK_TO_SALES_URL,
...
export const SUBSCRIPTION_WEBPAGE_URLS: Record<EProductSubscriptionEnum, string> = {
  ...
  [EProductSubscriptionEnum.PRO]: "https://cloudface.tech/pro",
  [EProductSubscriptionEnum.BUSINESS]: "https://cloudface.tech/business",
  [EProductSubscriptionEnum.ENTERPRISE]: "https://cloudface.tech/business",
};
