...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_plane: "Nowy w CloudPlane?",
  ...
  support: "Wsparcie",
  forum: "Forum",
  powered_by_plane_pages: "Oparte na CloudPlane Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Większość rzeczy zaczyna się od projektu w CloudPlane.",
        cta: "Zacznij",
      },
      invite_team: {
        title: "Zaproś zespół",
      ...
      personalize_account: {
        title: "Spersonalizuj CloudPlane.",
  ...
  workspace_creation: {
    ...
    subheading: "Aby korzystać z CloudPlane, musisz utworzyć lub dołączyć do przestrzeni roboczej.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Witaj w CloudPlane, cieszymy się, że jesteś. Utwórz pierwszy projekt, śledź elementy pracy, a ta strona stanie się centrum Twojego postępu. Administratorzy zobaczą tu również elementy pomocne zespołowi.",
        primary_button: {
          text: "Utwórz pierwszy projekt",
          comic: {
            title: "Wszystko zaczyna się od projektu w CloudPlane",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Skopiuj i zapisz ten klucz w CloudPlane Pages. Po zamknięciu nie będzie widoczny ponownie. Plik CSV z kluczem został pobrany.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Używaj API, aby zintegrować CloudPlane z zewnętrznymi systemami.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "CloudPlane będzie automatycznie archiwizował elementy, które zostały ukończone lub anulowane.",
        duration: "Archiwizuj elementy zamknięte dłużej niż",
      },
      "auto-close": {
        title: "Automatyczne zamykanie elementów",
        description: "CloudPlane będzie automatycznie zamykał elementy, które nie zostały ukończone lub anulowane.",
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "CloudPlane nie uruchomił się. Może to być spowodowane tym, że jedna lub więcej usług CloudPlane nie mogła się uruchomić.",
