...
const APP_TITLE = "CloudPlane Publish | Make your boards public with one-click";
const APP_DESCRIPTION = "CloudPlane Publish lets you share project boards publicly.";
