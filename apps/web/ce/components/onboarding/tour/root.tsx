...
import { CloseIcon, PlaneLockup } from "@cloudplane/propel/icons";
// assets
...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "The work item is the building block of CloudPlane. Most concepts in CloudPlane are either associated with work items and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
          ...
          <div className="h-full overflow-hidden">
            ...
            <div className="flex flex-col overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-18">
                Welcome to CloudPlane, {currentUser?.first_name} {currentUser?.last_name}
              </h3>
              <p className="mt-3 text-13 text-secondary">
                We{"'"}re glad that you decided to try out CloudPlane. You can now manage your projects with ease. Get
