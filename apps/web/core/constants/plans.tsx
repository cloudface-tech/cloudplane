...
import { EProductSubscriptionEnum } from "@cloudplane/types";
// cloudplane imports
import { cn } from "@cloudplane/utils";
...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
    ...
    features: [
      {
        ...
        description:
          "Track progress in cycles, modules, and overviews\nthroughout CloudPlane without switching to dashboards\nor Analytics.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      {
        title: "Power K",
        description: "Access a keyboard-first gateway to almost anything in CloudPlane.",
        cloud: {
          free: true,
          one: true,
          pro: true,
      ...
      // },
      {
        title: "PQL",
        description:
          "Write CloudPlane Query Language in search with support\nfor Boolean operators. Soon, you can write natural\nlanguage queries.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: "See a full-workspace audit log and use APIs to flag CloudPlane activity in compliance systems.",
        comingSoon: true,
        cloud: {
          free: false,
          one: false,
    ...
    features: [
      {
        title: "GitHub",
        description:
          "Sync CloudPlane work items and states to GitHub work items and\nstates. Update GitHub automatically with activity\nfrom CloudPlane and vice-versa.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Slack",
        description: "Get CloudPlane activity in Slack and use / commands in\nSlack to make changes in CloudPlane.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Zendesk",
        description: "Create CloudPlane work items from Zendesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Freshdesk",
        description: "Create CloudPlane work items from Freshdesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Choose other domains that can authenticate into\nyour CloudPlane workspace or restrict all but one domain.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      },
      {
        title: "LDAP",
        description:
          "Get our official LDAP implementation and secure\nyour CloudPlane workspace with your LDAP server.",
        comingSoon: true,
        cloud: {
          free: false,
          one: false,
  ...
  },
  {
    ...
    features: [
      {
        title: "God Mode",
        description: "Manage your self-hosted CloudPlane instance better with\nan instance admin interface.",
        cloud: {
          free: true,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description: "Install and deploy your self-hosted CloudPlane to any\nprivate cloud with a single-line command.",
        cloud: {
          free: false,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <a
              href="https://cloudface.tech/talk-to-sales"
              target="_blank"
