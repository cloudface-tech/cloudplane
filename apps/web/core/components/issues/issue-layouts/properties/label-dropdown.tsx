...
// cloudplane imports
import { EUserPermissionsLevel, getRandomLabelColor } from "@cloudplane/constants";
import { useOutsideClickDetector } from "@cloudplane/hooks";
import { useTranslation } from "@cloudplane/i18n";
import { CheckIcon, SearchIcon, ChevronDownIcon } from "@cloudplane/propel/icons";
// types
import type { IIssueLabel } from "@cloudplane/types";
import { EUserProjectRoles } from "@cloudplane/types";
// components
import { ComboDropDown } from "@cloudplane/ui";
import { sortBySelectedFirst } from "@cloudplane/utils";
// hooks
