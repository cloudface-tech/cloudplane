...
// cloudplane imports
import { API_BASE_URL, E_PASSWORD_STRENGTH, AUTH_TRACKER_ELEMENTS } from "@cloudplane/constants";
import { useTranslation } from "@cloudplane/i18n";
import { Button } from "@cloudplane/propel/button";
import { CloseIcon } from "@cloudplane/propel/icons";
import { Input, PasswordStrengthIndicator, Spinner } from "@cloudplane/ui";
import { getPasswordStrength } from "@cloudplane/utils";
// components
