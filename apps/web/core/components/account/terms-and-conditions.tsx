...
import { EAuthModes } from "@cloudplane/constants";
...
const LEGAL_LINKS = {
  termsOfService: "https://cloudface.tech/legals/terms-and-conditions",
  privacyPolicy: "https://cloudface.tech/legals/privacy-policy",
} as const;
