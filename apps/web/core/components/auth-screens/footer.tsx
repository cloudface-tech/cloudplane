...
import { AccentureLogo, DolbyLogo, SonyLogo, ZerodhaLogo } from "@cloudplane/propel/icons";
...
export function AuthFooter() {
  return (
    <div className="flex flex-col items-center gap-6">
      <span className="text-13 whitespace-nowrap text-tertiary">Join 10,000+ teams building with CloudPlane</span>
