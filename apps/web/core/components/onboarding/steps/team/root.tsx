...
// cloudplane imports
import type { EUserPermissions } from "@cloudplane/constants";
import { ROLE, ROLE_DETAILS } from "@cloudplane/constants";
import { useTranslation } from "@cloudplane/i18n";
import { Button } from "@cloudplane/propel/button";
import { PlusIcon, CheckIcon, ChevronDownIcon } from "@cloudplane/propel/icons";
import { TOAST_TYPE, setToast } from "@cloudplane/propel/toast";
import { EOnboardingSteps } from "@cloudplane/types";
import { Input, Spinner } from "@cloudplane/ui";
// hooks
  ...
  return (
    ...
    >
      <CommonOnboardingHeader
        ...
        description="Work in CloudPlane happens best with your team. Invite them now to use CloudPlane to its potential."
      />
