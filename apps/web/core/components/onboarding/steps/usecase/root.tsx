...
// cloudplane imports
import { USE_CASES } from "@cloudplane/constants";
import { Button } from "@cloudplane/propel/button";
import { CheckIcon } from "@cloudplane/propel/icons";
import { TOAST_TYPE, setToast } from "@cloudplane/propel/toast";
import type { TUserProfile } from "@cloudplane/types";
...
export const UseCaseSetupStep = observer(function UseCaseSetupStep({ handleStepChange }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      {/* Header */}
      <CommonOnboardingHeader title="What brings you to CloudPlane?" description="Tell us your goals and team size." />
