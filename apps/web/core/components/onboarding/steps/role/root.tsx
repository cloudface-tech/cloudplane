...
import { CheckIcon, ViewsIcon } from "@cloudplane/propel/icons";
...
export const RoleSetupStep = observer(function RoleSetupStep({ handleStepChange }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      {/* Header */}
      <CommonOnboardingHeader title="What's your role?" description="Let's set up CloudPlane for how you work." />
      {/* Role Selection */}
