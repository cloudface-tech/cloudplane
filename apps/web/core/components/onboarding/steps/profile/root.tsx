...
// cloudplane imports
import { E_PASSWORD_STRENGTH } from "@cloudplane/constants";
import { Button } from "@cloudplane/propel/button";
import { TOAST_TYPE, setToast } from "@cloudplane/propel/toast";
import type { IUser } from "@cloudplane/types";
import { EOnboardingSteps } from "@cloudplane/types";
import { cn, getFileURL, getPasswordStrength, validatePersonName } from "@cloudplane/utils";
// components
...
export const ProfileSetupStep = observer(function ProfileSetupStep({ handleStepChange }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      {/* Header */}
      <CommonOnboardingHeader title="Create your profile." description="This is how you will appear in CloudPlane." />
