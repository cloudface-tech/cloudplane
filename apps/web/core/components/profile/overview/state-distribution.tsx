...
// cloudplane imports
import { STATE_GROUPS } from "@cloudplane/constants";
import { useTranslation } from "@cloudplane/i18n";
import { PieChart } from "@cloudplane/propel/charts/pie-chart";
import { EmptyStateCompact } from "@cloudplane/propel/empty-state";
import type { IUserProfileData, IUserStateDistribution } from "@cloudplane/types";
import { Card } from "@cloudplane/ui";
import { capitalizeFirstLetter } from "@cloudplane/utils";
