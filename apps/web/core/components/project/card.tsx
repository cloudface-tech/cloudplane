...
// cloudplane imports
import { EUserPermissions, EUserPermissionsLevel, IS_FAVORITE_MENU_OPEN } from "@cloudplane/constants";
import { useLocalStorage } from "@cloudplane/hooks";
import { Button } from "@cloudplane/propel/button";
import { Logo } from "@cloudplane/propel/emoji-icon-picker";
import { LinkIcon, LockIcon, NewTabIcon, TrashIcon, CheckIcon } from "@cloudplane/propel/icons";
import { setPromiseToast, setToast, TOAST_TYPE } from "@cloudplane/propel/toast";
import { Tooltip } from "@cloudplane/propel/tooltip";
import type { IProject } from "@cloudplane/types";
import type { TContextMenuItem } from "@cloudplane/ui";
import { Avatar, AvatarGroup, ContextMenu, FavoriteStar } from "@cloudplane/ui";
import { copyUrlToClipboard, cn, getFileURL, renderFormattedDate } from "@cloudplane/utils";
// components
// hooks
