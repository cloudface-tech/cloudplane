...
import { USER_TRACKER_ELEMENTS } from "@cloudplane/constants";
import { useTranslation } from "@cloudplane/i18n";
// ui
import { getButtonStyling } from "@cloudplane/propel/button";
import { PlaneLogo } from "@cloudplane/propel/icons";
// helpers
    ...
    <div className="m-6 mb-4 flex flex-shrink-0 items-center justify-between gap-4">
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          href="https://cloudface.tech/changelog"
          target="_blank"
          className="text-13 text-secondary underline-offset-1 outline-none hover:text-primary hover:underline"
          rel="noreferrer"
        >
        ...
        <a
          href="mailto:support@cloudface.tech"
          target="_blank"
          className="text-13 text-secondary underline-offset-1 outline-none hover:text-primary hover:underline"
          rel="noreferrer"
        >
      ...
      <a
        href="https://cloudface.tech/pages"
        target="_blank"
        className={cn(
