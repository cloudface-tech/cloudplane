...
// cloudplane imports
// helpers
import type { EProductSubscriptionEnum, TBillingFrequency, TSubscriptionPrice } from "@cloudplane/types";
import { cn, getBaseSubscriptionName, getSubscriptionName } from "@cloudplane/utils";
          ...
          {prices.map((price: TSubscriptionPrice) => (
            <Tab.Panel key={price.key}>
              <div className="pt-6 text-center">
                <div className="text-h4-medium">CloudPlane {planeName}</div>
