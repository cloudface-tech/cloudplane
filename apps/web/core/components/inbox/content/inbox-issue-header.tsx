...
// cloudplane imports
import { EUserPermissions, EUserPermissionsLevel } from "@cloudplane/constants";
import { useTranslation } from "@cloudplane/i18n";
import { Button } from "@cloudplane/propel/button";
import { IconButton, getIconButtonStyling } from "@cloudplane/propel/icon-button";
import {
  LinkIcon,
  CopyIcon,
  NewTabIcon,
...
} from "@cloudplane/propel/icons";
import { TOAST_TYPE, setToast } from "@cloudplane/propel/toast";
import type { TNameDescriptionLoader } from "@cloudplane/types";
import { EInboxIssueStatus } from "@cloudplane/types";
import { ControlLink, CustomMenu, Row } from "@cloudplane/ui";
import { copyUrlToClipboard, findHowManyDaysLeft, generateWorkItemLink } from "@cloudplane/utils";
// components
