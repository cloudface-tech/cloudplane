...
import { Row, Avatar } from "@cloudplane/ui";
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            {/* created by */}
            {createdByDetails && createdByDetails.email?.includes("intake@cloudface.tech") ? (
              <Avatar src={getFileURL("")} name={"CloudPlane"} size="md" showTooltip />
            ) : createdByDetails ? (
