...
// cloudplane imports
import type { EditorRefApi } from "@cloudplane/editor";
import { useTranslation } from "@cloudplane/i18n";
import { Button } from "@cloudplane/propel/button";
import { CopyIcon, ChevronLeftIcon, ChevronRightIcon } from "@cloudplane/propel/icons";
import { setToast, TOAST_TYPE } from "@cloudplane/propel/toast";
import { Tooltip } from "@cloudplane/propel/tooltip";
import type { TDescriptionVersion } from "@cloudplane/types";
import { Avatar, EModalPosition, EModalWidth, Loader, ModalCore } from "@cloudplane/ui";
import { calculateTimeAgo, cn, getFileURL } from "@cloudplane/utils";
// components
