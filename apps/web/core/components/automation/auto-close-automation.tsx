...
// cloudplane imports
import { PROJECT_AUTOMATION_MONTHS, EUserPermissions, EUserPermissionsLevel, EIconSize } from "@cloudplane/constants";
import { useTranslation } from "@cloudplane/i18n";
import { StateGroupIcon, StatePropertyIcon } from "@cloudplane/propel/icons";
import type { IProject } from "@cloudplane/types";
import { CustomSelect, CustomSearchSelect, ToggleSwitch, Loader } from "@cloudplane/ui";
