...
// cloudplane imports
import type { EditorRefApi, TExtensions } from "@cloudplane/editor";
import { useTranslation } from "@cloudplane/i18n";
import type { EFileAssetType, TNameDescriptionLoader } from "@cloudplane/types";
import { getDescriptionPlaceholderI18n } from "@cloudplane/utils";
// components
