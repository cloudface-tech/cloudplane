...
import { PageIcon } from "@cloudplane/propel/icons";
// ui
  ...
  return (
    <>
      ...
      <CustomMenu
        ...
        closeOnSelect
      >
        <CustomMenu.MenuItem onClick={() => window.open("https://docs.cloudface.tech/", "_blank")}>
        ...
        <CustomMenu.MenuItem onClick={() => window.open("mailto:sales@cloudface.tech", "_blank")}>
          <div className="flex items-center gap-x-2 rounded-sm text-11">
        ...
        <CustomMenu.MenuItem
          onClick={() => window.open("https://forum.cloudface.tech", "_blank", "noopener,noreferrer")}
        >
          <div className="flex items-center gap-x-2 rounded-sm text-11">
