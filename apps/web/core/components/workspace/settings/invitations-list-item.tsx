...
// cloudplane imports
import { ROLE, EUserPermissions, EUserPermissionsLevel } from "@cloudplane/constants";
import { useTranslation } from "@cloudplane/i18n";
import { LinkIcon, TrashIcon, ChevronDownIcon } from "@cloudplane/propel/icons";
import { TOAST_TYPE, setToast } from "@cloudplane/propel/toast";
import type { TContextMenuItem } from "@cloudplane/ui";
import { CustomSelect, CustomMenu } from "@cloudplane/ui";
import { cn, copyTextToClipboard } from "@cloudplane/utils";
// components
