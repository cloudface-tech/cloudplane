...
import { WEB_BASE_URL } from "@cloudplane/constants";
// plane internal packages
import { GithubIcon, NewTabIcon, PageIcon } from "@cloudplane/propel/icons";
...
const helpOptions = [
  {
    name: "Documentation",
    href: "https://docs.cloudface.tech/",
    Icon: PageIcon,
  },
  {
    name: "Join our Forum",
    href: "https://forum.cloudface.tech",
    Icon: MessageSquare,
  },
  {
    name: "Report a bug",
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to CloudPlane" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to CloudPlane"}
          </a>
        </Tooltip>
