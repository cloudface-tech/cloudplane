...
import type { TInstanceConfigurationKeys, TInstanceAuthenticationModes } from "@cloudplane/types";
import { Loader, ToggleSwitch } from "@cloudplane/ui";
import { cn, resolveGeneralTheme } from "@cloudplane/utils";
// components
...
export const meta: Route.MetaFunction = () => [{ title: "Authentication Settings - CloudPlane Admin" }];
