...
import type { IFormattedInstanceConfiguration, TInstanceEmailConfigurationKeys } from "@cloudplane/types";
// ui
...
export function InstanceEmailForm(props: IInstanceEmailForm) {
  ...
  const emailFormFields: TControllerInputFormField[] = [
    ...
    },
    {
      ...
      placeholder: "no-reply@cloudface.tech",
  ...
  const OptionalEmailFormFields: TControllerInputFormField[] = [
    {
      ...
      type: "text",
      label: "Username",
      placeholder: "getitdone@cloudface.tech",
