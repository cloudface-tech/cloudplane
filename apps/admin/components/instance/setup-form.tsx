...
import { API_BASE_URL, E_PASSWORD_STRENGTH } from "@cloudplane/constants";
import { Button } from "@cloudplane/propel/button";
import { AuthService } from "@cloudplane/services";
import { Checkbox, Input, PasswordStrengthIndicator, Spinner } from "@cloudplane/ui";
import { getPasswordStrength, validatePersonName, validateCompanyName } from "@cloudplane/utils";
// components
    ...
    <>
      ...
      <div className="mt-10 flex w-full flex-grow flex-col items-center justify-center py-6">
        <div className="relative flex w-full max-w-[22.5rem] flex-col gap-6">
          <FormHeader
            heading="Setup your CloudPlane Instance"
            subHeading="Post setup you will be able to manage this CloudPlane instance."
          />
          {errorData.type &&
            errorData?.message &&
          ...
          >
            ...
            <div className="relative flex gap-2">
              ...
              <label className="cursor-pointer text-13 font-medium text-tertiary" htmlFor="is_telemetry_enabled">
                Allow CloudPlane to anonymously collect usage events.{" "}
                <a
                  tabIndex={-1}
                  href="https://developers.cloudface.tech/self-hosting/telemetry"
                  target="_blank"
